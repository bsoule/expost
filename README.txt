BEGIN_MAGIC[ExPost: Render HTML from Etherpads and Use Etherpad Instead of the Wordpress Editor]

*Dogfoodaliciousness: This page is rendered live from <http://padm.us/expost>.*

## Critical TODOs for Beemblog

1. "Preview Changes" doesn't show a preview of latest etherpad content.
2. I haven't tested what happens if you schedule a post for future publication.


## Needed for releasing the plugin to others
...
Expost replaces each occurrence of $ REF[foo] (without the space after the dollar sign; that's just there for the obvious meta reason) with a unique number, starting with 1 for the first $REF occurrence and counting up sequentially with each new tag.
